...
public class ConsumingOverlayContainer<C extends Component> extends WrappingParentComponent<C> {
    ...
    protected ConsumingOverlayContainer(C child) {
     ...
     */
    public ConsumingOverlayContainer<C> closeOnClick(boolean closeOnClick) {
    ...
    public ConsumingOverlayContainer<C> slotsToDisable(List<DisableableSlotItemHandler> actualSlots) {
