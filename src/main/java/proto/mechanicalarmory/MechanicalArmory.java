...
public class MechanicalArmory {
    ...
    // Create a Deferred Register to hold CreativeModeTabs which will all be registered under the "mechanicalarmory" namespace
    ...
    public static final DeferredBlock<Block> EXAMPLE_BLOCK = proto.mechanicalarmory.Blocks.BLOCKS.registerSimpleBlock("example_block", BlockBehaviour.Properties.of().mapColor(MapColor.STONE));
    ...
    // Creates a creative tab with the id "mechanicalarmory:example_tab" for the example item, that is placed after the combat tab
    ...
    public MechanicalArmory(IEventBus modEventBus, ModContainer modContainer) {
        ...
        proto.mechanicalarmory.Blocks.BLOCKS.register(modEventBus);
